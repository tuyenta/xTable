        ...
        for i, (mdef, module) in enumerate(zip(self.module_defs, self.module_list)):
            ...
            if mtype in ["convolutional", "upsample", "maxpool"]:
                ...
                if len(layers) == 1:
                    ...
                    except Exception:  # apply stride 2 for darknet reorg layer
            ...
            if verbose:
                print(
                    "%g/%g %s -" % (i, len(self.module_list), mtype), list(x.shape), str
                )
                str = ""
...
def get_yolo_layers(model):
    return [
        i for i, x in enumerate(model.module_defs) if x["type"] == "yolo"
