...
def test_text_plot():
    ...
    return xtable.plot(tables[0], kind="text")
...
def test_textedge_plot():
    ...
    return xtable.plot(tables[0], kind="textedge")
...
def test_lattice_contour_plot_poppler():
    ...
    return xtable.plot(tables[0], kind="contour")
...
def test_line_plot_poppler():
    filename = os.path.join(testdir, "foo.pdf")
    tables = xtable.read_pdf(filename, backend="poppler")
    return xtable.plot(tables[0], kind="line")
...
def test_joint_plot_poppler():
    filename = os.path.join(testdir, "foo.pdf")
    tables = xtable.read_pdf(filename, backend="poppler")
    return xtable.plot(tables[0], kind="joint")
...
def test_grid_plot_poppler():
    filename = os.path.join(testdir, "foo.pdf")
    tables = xtable.read_pdf(filename, backend="poppler")
    return xtable.plot(tables[0], kind="grid")
